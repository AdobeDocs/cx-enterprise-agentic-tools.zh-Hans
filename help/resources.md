...
![资源](https://placehold.co/1600x900?text=Adobe+CX+Enterprise+Resources)

在一个位置使用Adobe CX Enterprise Agentic Tools的所有关键Adobe资源。
...
| 资源 | 您将找到什么 |
|---|---|
| [Adobe Experience Platform API](https://developer.adobe.com/experience-platform-apis/) | AEP API引用：数据集、架构、配置文件、查询、分段 |
| [Adobe Journey Optimizer API](https://developer.adobe.com/journey-optimizer-apis/) | AJO API参考：历程、营销活动、内容、offer decisioning |
| [Customer Journey Analytics API](https://developer.adobe.com/cja-apis/docs/) | CJA API引用：analytics数据、报表、分析 |
| [数据收集API](https://developer.adobe.com/data-collection-apis/docs/) | Edge Network摄取，实时事件收集，流 |
| [Adobe Events API](https://developer.adobe.com/events/docs/) | 事件驱动型集成、Webhook、自动化触发器 |
| [Adobe客户端SDK](https://developer.adobe.com/client-sdks/home/) | 移动SDK、边缘SDK、应用程序内消息传送 |
| [隐私API](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/privacy/home) | 隐私工作流、数据管理、数据主体请求 |
| [用户管理API](https://developer.adobe.com/umapi/) | 用户管理、身份管理、企业帐户 |
| [Audience Manager API](https://developer.adobe.com/audience-manager/) | 受众管理和激活工作流 |

## 开发人员设置

| 资源 | 您将找到什么 |
|---|---|
| [Adobe Developer Console](https://developer.adobe.com/developer-console/docs/guides/) | API项目设置、身份验证和凭据管理 |
| [开发人员快速入门指南](https://developer.adobe.com/dep/) | 使用Adobe API构建简介 |

## AI客户端设置

| 资源 | 您将找到什么 |
|---|---|
| [克劳德代码MCP文档](https://docs.anthropic.com/en/docs/claude-code/mcp) | 如何将MCP服务器添加到Claude代码 |
| [克劳德代码概述](https://docs.anthropic.com/en/docs/claude-code/overview) | Claude代码快速入门 |
